...
<div id="tabs">
    <ul>
        ...
        <li><a href="#tabs-6">Configuations</a></li>
                    ...
                    <tr>
                        <td>
                            <button type="submit" name="action" value="submit"
                                    font-family="Verdana,Arial,sans-serif; font-size: 1em;">Save Clinical Data
                            </button>
                        </td>
                    </tr>
    ...
    <div id="tabs-2">
                    ...
                    <tr>
                        <td>
                            <button type="submit" name="action" value="query"
                                    font-family="Verdana,Arial,sans-serif; font-size: 1em;">Query Clinical Data
                            </button>
                        </td>
                    </tr>
                    <tr>
        ...
        <div style="display:inline-block;border:1px solid green;width:100%;height:100%" class="padding;">
                        ...
                        <pre>
  <c:out value="${form.queryDataResult}"/>
</pre>
    ...
    <div id="tabs-3">
        <div style="display:inline-block;border:1px solid green;" class="padding">
            <form:form method="POST" commandName="patient" onsubmit="createPatient()">
                <table cellpadding="10">
                    ...
                    <tr>
                        <td>
                            <button type="submit" name="action" value="patient"
                                    font-family="Verdana,Arial,sans-serif; font-size: 1em;">Create Patient
                            </button>
                        </td>
                    </tr>
                </table>
        ...
        <div style="display:inline-block;border:1px solid green;width:100%;height:100%" class="padding">
            <table>
                <tr>
                    <th bgcolor="#008000">Request</th>
                </tr>
                <tr>
                    <td>

                                    <pre>
  <c:out value="${form.query}"/>
</pre>
                    </td>
                </tr>
            </table>
  ...
  <c:out value="${form.createPatientResult}"/>
            ...
            <br/>
            <a href="<c:url value="${form.showUrl}"/>" target="_blank">See patient here</a>
        </div>
    ...
    <div id="tabs-4">
            ...
            <form:form method="POST" id="frm" commandName="search" onsubmit="queryPatient()">
                <table cellpadding="10">
                    ...
                    <tr>
                        ...
                        <td><label id="queryPatientWarnMsg"></label></td>
                    </tr>
                    <tr>
                        <td>Identifier Type</td>
                        <td><input type="text" id="identifierType" name="identifierType"></td>
                        <td><label id="queryPatientWarnMsg"></label></td>
                    </tr>
                    <tr></tr>
                    <tr>
                        <td>
                            <button type="submit" name="action" value="search"
                                    font-family="Verdana,Arial,sans-serif; font-size: 1em;">Query Patient
                            </button>
                        </td>
                    </tr>
                    <tr>
        ...
        <div id="patientQuery" style="display:inline-block;border:1px solid green;width:100%;height:100%"
             class="padding">
            <table>
                <tr>
                    <th bgcolor="#008000">Request</th>
                ...
                <tr>
                    <td>
            <pre>
  <c:out value="${form.patientQuery.query}"/>
</pre>
                    </td>
                </tr>
            </table>
            ...
            <form:form method="POST" id="queryFacility" commandName="search" onsubmit="return queryFacility()">
                <table cellpadding="10">
                    ...
                    <tr>
                        ...
                        <td><label id="facilityWarnMsg"></label></td>
                    </tr>
                    <tr>
                        <td>Maximum Responses</td>
                        <td><input type="text" id="maxresponses" name="maxresponses"></td>
                    </tr>
                    <tr></tr>
                    <tr>
                        <td>
                            <button type="submit" name="action" value="searchFacility"
                                    font-family="Verdana,Arial,sans-serif; font-size: 1em;">Query Facility
                            </button>
                        </td>
                    </tr>
                    <tr>
        ...
        <div style="display:inline-block;border:1px solid green;width:100%;height:100%" class="padding;">
            <table>
                ...
                <tr>
                    <td>
            <pre>
  <c:out value="${form.queryFacilityRequest}"/>
</pre>
                    </td>
                </tr>
            </table>
            ...
            <form:form method="POST" id="queryProvider" commandName="search" onsubmit=" return queryProvider()">
                <table cellpadding="10">
                    ...
                    <tr>
                        ...
                        <td><label id="providerWarnMsg"></label></td>
                    </tr>
                    <tr>
                        <td>Maximum Responses</td>
                        <td><input type="text" id="maxProviderresponses" name="maxresponses"></td>
                    </tr>
                    <tr></tr>
                    <tr>
                        <td>
                            <button type="submit" name="action" value="searchProvider"
                                    font-family="Verdana,Arial,sans-serif; font-size: 1em;">Query Provider
                            </button>
                        </td>
                    </tr>
                    <tr>
        ...
        <div style="display:inline-block;border:1px solid green;width:100%;height:100%" class="padding;">
            <table>
                ...
                <tr>
                    <td>
                        <pre>
  <c:out value="${form.queryProviderRequest}"/>
</pre>
