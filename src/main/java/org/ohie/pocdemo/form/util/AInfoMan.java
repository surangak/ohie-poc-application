 ...
 * InfoMan
 */
public class AInfoMan {

    private static final Log log = LogFactory.getLog(AInfoMan.class);
...
//System.out.println(this.original);
    ...
    public final static void setDefaultMax(final Integer defaultMax) {
        AInfoMan.defaultMax = defaultMax;
    }

    public final static void setCredentials(String username, String password) {
        AInfoMan.USERNAME = username;
        AInfoMan.PASSWORD = password;
    }
